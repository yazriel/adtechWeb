...
function preventDefaultWalletContent(event: React.MouseEvent) {
  event.preventDefault();
}

interface TitlePropsWalletContent {
  children?: React.ReactNode;
}


function TitleWalletContent(props: TitlePropsWalletContent) {
  return (
...
function WalletContent() {
  return (
    <React.Fragment>
      <TitleWalletContent>Recent Deposits</TitleWalletContent>
      ...
      <div>
        <Link color="primary" href="#" onClick={preventDefaultWalletContent}>
          View balance
        </Link>
      </div>
    </React.Fragment>
